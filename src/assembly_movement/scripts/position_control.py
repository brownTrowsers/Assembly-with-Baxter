...
def read(file):
    ...
    pos_1 = pos_2 = pos_3 = pos_4 = pos_5 = pos_6 = pos_7 = pos_8 = None
    ...
    for i, word in enumerate(words):
        ...
        if(word == 'position_7:'):
            for j in range(21):
                pos_7 = namCheckandReturn(words,i,j,pos_7,".x","pos")
                pos_7 = namCheckandReturn(words,i,j,pos_7,".y","pos")
                pos_7 = namCheckandReturn(words,i,j,pos_7,".z","pos")
                pos_7 = namCheckandReturn(words,i,j,pos_7,".x","ori")
                pos_7 = namCheckandReturn(words,i,j,pos_7,".y","ori")
                pos_7 = namCheckandReturn(words,i,j,pos_7,".z","ori")
                pos_7 = namCheckandReturn(words,i,j,pos_7,".w","ori")
        if(word == 'position_8:'):
            for j in range(21):
                pos_8 = namCheckandReturn(words,i,j,pos_8,".x","pos")
                pos_8 = namCheckandReturn(words,i,j,pos_8,".y","pos")
                pos_8 = namCheckandReturn(words,i,j,pos_8,".z","pos")
                pos_8 = namCheckandReturn(words,i,j,pos_8,".x","ori")
                pos_8 = namCheckandReturn(words,i,j,pos_8,".y","ori")
                pos_8 = namCheckandReturn(words,i,j,pos_8,".z","ori")
                pos_8 = namCheckandReturn(words,i,j,pos_8,".w","ori")
    f.close()

    return pos_1, pos_2, pos_3, pos_4, pos_5, pos_6, pos_7, pos_8
...
class PosControl(object):
    ...
    def abovePosition(self):
        ...
        while not rospy.is_shutdown():
            self._pub_rate.publish(self._rate)
            p1,p2,p3,p4,p5,p6,p7,p8 = read(self.pos)

            com = 0
            com = raw_input("position: ")

            if(com == '1' and len(com) < 2):
                self.moveToCoords('left',p1)
            elif(com == '2' and len(com) < 2):
                self.moveToCoords('left',p2)
            elif(com == '3' and len(com) < 2):
                self.moveToCoords('left',p3)
                ...
                self.moveToCoords('right',p6)
            elif(com == '7' and len(com) < 2):
                self.moveToCoords('right',p7)
            elif(com == '8' and len(com) < 2):
                self.moveToCoords('right',p8)
